...
main_dr = 'C:/Users/古内翔平/OneDrive - 株式会社　ＴＲＩＮＩＴＹ　/業務会議/4⃣販売部/古内/myfile'
...
if wd_no == 0:# 月曜日⇒0 火曜日⇒ 1 水曜日⇒ 2 木曜日⇒ 3 金曜日⇒ 4 土曜日⇒ 5 日曜日⇒ 6
  cl_sheet = pd.read_excel('C:/Users/古内翔平/OneDrive - 株式会社　ＴＲＩＮＩＴＹ　/業務会議/4⃣販売部/古内/myfile/クリアBOOK.xlsx')
  ...
  for fd in folders:
    ...
    for i in no:
      ...
      del_path = 'C:/Users/古内翔平/OneDrive - 株式会社　ＴＲＩＮＩＴＹ　/業務会議/4⃣販売部/古内/myfile/'+str(fd)+'/'+str(i)+'商品実績.xlsx'
      print(del_path)
      cl_df.to_excel(del_path)
      
  #ーーーーーーーーー実績ファイルクリアーーーーーーーーーーーーー
  
  cl_df.to_excel('C:/Users/古内翔平/OneDrive - 株式会社　ＴＲＩＮＩＴＹ　/業務会議/4⃣販売部/古内/myfile/0/実績/実績.xlsx')
  cl_df.to_excel('C:/Users/古内翔平/OneDrive - 株式会社　ＴＲＩＮＩＴＹ　/業務会議/4⃣販売部/古内/myfile/1/実績/実績.xlsx')
  cl_df.to_excel('C:/Users/古内翔平/OneDrive - 株式会社　ＴＲＩＮＩＴＹ　/業務会議/4⃣販売部/古内/myfile/2/実績/実績.xlsx')
  cl_df.to_excel('C:/Users/古内翔平/OneDrive - 株式会社　ＴＲＩＮＩＴＹ　/業務会議/4⃣販売部/古内/myfile/3/実績/実績.xlsx')
  cl_df.to_excel('C:/Users/古内翔平/OneDrive - 株式会社　ＴＲＩＮＩＴＹ　/業務会議/4⃣販売部/古内/myfile/4/実績/実績.xlsx')
  cl_df.to_excel('C:/Users/古内翔平/OneDrive - 株式会社　ＴＲＩＮＩＴＹ　/業務会議/4⃣販売部/古内/myfile/5/実績/実績.xlsx')
  cl_df.to_excel('C:/Users/古内翔平/OneDrive - 株式会社　ＴＲＩＮＩＴＹ　/業務会議/4⃣販売部/古内/myfile/6/実績/実績.xlsx')
...
dr_files = 'C:/Users/古内翔平/OneDrive - 株式会社　ＴＲＩＮＩＴＹ　/業務会議/4⃣販売部/古内/myfile/dataf'
...
dr_files_2 = 'C:/Users/古内翔平/OneDrive - 株式会社　ＴＲＩＮＩＴＹ　/業務会議/4⃣販売部/古内/myfile/売上実績'  
        ...
        if base == '商品別売上集計':
            ...
            for i, file in enumerate(filelists):
                if i > MAX_CNT-1:
                    ...
                    shutil.move("C:/Users/古内翔平/Downloads/" + '全店.csv','C:/Users/古内翔平/OneDrive - 株式会社　ＴＲＩＮＩＴＹ　/業務会議/4⃣販売部/古内/myfile/dataf')                        
time.sleep(1)                    
...
for i_1 in tenpo_list:
 #店舗名指定上段
  driver.find_element(By.ID, "ContentPlaceHolder1_DropDownList4").click()
  #店舗選択
  driver.find_element(By.ID, "ContentPlaceHolder1_DropDownList4").send_keys(i_1[4])
  #CSV出力
  driver.find_element(By.ID, "ContentPlaceHolder1_btnCSV").click()
          ...
          if base == '商品別売上集計':
              ...
              for i, file in enumerate(filelists):
                  if i > MAX_CNT-1:
                      ...
                      shutil.move("C:/Users/古内翔平/Downloads/" + str(i_1[2]) + '.csv','C:/Users/古内翔平/OneDrive - 株式会社　ＴＲＩＮＩＴＹ　/業務会議/4⃣販売部/古内/myfile/dataf') 
...
driver.get('http://tri.hanbai-net.com/system/30010301.aspx?id=010199')
#全店実績
        ...
        if base == '販売伝票明細':#販売分析ログ
            ...
            for i, file in enumerate(filelists):
                if i > MAX_CNT-1:
                    print(file[0])
                    #file_1 = os.rename(i[0], 'kasi.csv')
                    os.rename("C:/Users/古内翔平/Downloads/" + file[0], 'C:/Users/古内翔平/Downloads/全店販売伝票明細.csv')
                    shutil.move('C:/Users/古内翔平/Downloads/全店販売伝票明細.csv','C:/Users/古内翔平/OneDrive - 株式会社　ＴＲＩＮＩＴＹ　/業務会議/4⃣販売部/古内/myfile/dataf') 
...
for i_1 in tenpo_list_2:
  ...
  #店舗名指定上段
  shop_input = driver.find_element(By.ID, "ContentPlaceHolder1_DropDownList9")
  
  shop_input_select = Select(shop_input)
  shop_input_select.select_by_value(str(i_1[5]))#.click()
          ...
          if base == '販売伝票明細':#販売分析ログ
              ...
              for i, file in enumerate(filelists):
                  if i > MAX_CNT-1:
                      print(file[0])
                      #file_1 = os.rename(i[0], 'kasi.csv')
                      os.rename("C:/Users/古内翔平/Downloads/" + str(file[0]), "C:/Users/古内翔平/Downloads/" + str(i_1[2]) + '販売伝票明細.csv')
                      shutil.move("C:/Users/古内翔平/Downloads/" + str(i_1[2]) + '販売伝票明細.csv','C:/Users/古内翔平/OneDrive - 株式会社　ＴＲＩＮＩＴＹ　/業務会議/4⃣販売部/古内/myfile/dataf') 
        ...
        if base == '売上集計':
            ...
            for i, file in enumerate(filelists):
                if i > MAX_CNT-1:
                    print(file[0])
                    #file_1 = os.rename(i[0], 'kasi.csv')
                    os.rename("C:/Users/古内翔平/Downloads/" + str(file[0]), "C:/Users/古内翔平/Downloads/" + '売上実績.csv')
                    shutil.move("C:/Users/古内翔平/Downloads/" + '売上実績.csv','C:/Users/古内翔平/OneDrive - 株式会社　ＴＲＩＮＩＴＹ　/業務会議/4⃣販売部/古内/myfile/売上実績')
...
file_path = 'C:/Users/古内翔平/OneDrive - 株式会社　ＴＲＩＮＩＴＹ　/業務会議/4⃣販売部/古内/myfile/dataf'
...
files_list.remove("全店販売伝票明細.csv")    
#顧客データ分析

range_count = len(files_list) #- 1

#folder_path = 'C:/Users/古内翔平/OneDrive - 株式会社　ＴＲＩＮＩＴＹ　/Desktop/analysis/create_file/'
#folder_path = 'C:/Users/古内翔平/OneDrive - 株式会社　ＴＲＩＮＩＴＹ　/業務会議/4⃣販売部/古内/analysis/create_file/'
folder_path = 'C:/Users/古内翔平/Desktop/create_file/'
...
for file_n,n in zip(files_list,range(0,int(range_count))) :
  ...
  r_file2 = pd.read_csv("C:/Users/古内翔平/OneDrive - 株式会社　ＴＲＩＮＩＴＹ　/業務会議/4⃣販売部/古内/myfile/売上実績/売上実績.csv",encoding="cp932")#売上集計
  ...
  shop = file_n.replace('販売伝票明細.csv','')#店名
  
  #店別季節データをを抽出
  #==========================================================================================================

  shop_r_file3 = pd.read_csv("C:/Users/古内翔平/OneDrive - 株式会社　ＴＲＩＮＩＴＹ　/業務会議/4⃣販売部/古内/myfile/dataf/" + str(shop) + ".csv",encoding="cp932")#商品別売上集計
  ...
  print(folder_path + file_name_1[0])
