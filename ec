...
#出力ログファイル"
LogFile = "C:/Users/fun-f/OneDrive - 株式会社　ＴＲＩＮＩＴＹ　/業務会議/6⃣EC部/SHOPLIST売上出力ログ.xlsx"
...
#置き換えリスト
ReDataList = "C:/Users/fun-f/OneDrive - 株式会社　ＴＲＩＮＩＴＹ　/業務会議/6⃣EC部/SHOPLIST品番置換え.xlsx"
r_ReDataList = pd.read_excel(ReDataList)

df_ReDataList = pd.DataFrame(r_ReDataList)

dr_files = 'C:/Users/fun-f/OneDrive - 株式会社　ＴＲＩＮＩＴＹ　/業務会議/4⃣販売部/古内/SHOPLIST_DATA'
#"C:/Users/FUN-PC34/OneDrive - 株式会社　ＴＲＩＮＩＴＹ　 (1)/業務会議"
#"C:/Users/fun-f/OneDrive - 株式会社　ＴＲＩＮＩＴＹ　/業務会議/6⃣EC部/SHOPLIST品番置換え.xlsx"
dr_read = os.listdir(dr_files)

print(dr_read)

#追記コード
for d_n in range(30,32):
    ...
    def item_data():
        ...
        for file in os.listdir("C:/Users/fun-f/Downloads"):#ディレクトリ内をfor文で取り出す 
            if key_word in file:
                ...
                shutil.move('SHOPLIST商品データ.csv',"C:/Users/fun-f/OneDrive - 株式会社　ＴＲＩＮＩＴＹ　/業務会議/4⃣販売部/古内/SHOPLIST_DATA") 
    ...
    time.sleep(2)
    driver.find_element_by_xpath('//*[@id="searchArea"]/div/table/tbody/tr/td/select').send_keys("2023-05")
    ...
    today = "202305" + str(d_n).zfill(2)#datetime.datetime.today() - timedelta(days=1)

    year_n = "2023"#today.year
    month_n = "05"#today.month
    day_n = d_n#today.day
    ...
    for file in os.listdir("C:/Users/fun-f/Downloads"):#ディレクトリ内をfor文で取り出す 
        if key_word in file:
            ...
            time.sleep(2)
            shutil.move('SHOPLIST売上データ.csv',"C:/Users/fun-f/OneDrive - 株式会社　ＴＲＩＮＩＴＹ　/業務会議/4⃣販売部/古内/SHOPLIST_DATA") 

    driver.close()                          
                            
    file_path = "C:/Users/fun-f/OneDrive - 株式会社　ＴＲＩＮＩＴＹ　/業務会議/4⃣販売部/古内/SHOPLIST_DATA/SHOPLIST売上データ.csv" 
    ...
    OUTPUT_FILE = "C:/Users/fun-f/OneDrive - 株式会社　ＴＲＩＮＩＴＹ　/業務会議/6⃣EC部/SHOPLIST_DATA_OUTPUT/test●外部データ連携_売上返品データ(SHOPLIST).xlsx"
    #
    C_element = '0' #現金区分
    ...
    for insert_data in compe_list.values:
        ...
        wb.save("C:/Users/fun-f/OneDrive - 株式会社　ＴＲＩＮＩＴＹ　/業務会議/6⃣EC部/SHOPLIST_DATA_OUTPUT/test●外部データ連携_売上返品データ(SHOPLIST).xlsx"
        )
        ...
        log_wb.save("C:/Users/fun-f/OneDrive - 株式会社　ＴＲＩＮＩＴＹ　/業務会議/6⃣EC部/SHOPLIST売上出力ログ.xlsx")
        #==============================================================================================
